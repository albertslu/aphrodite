...
# Process profiles
def extract_profiles_with_conversion(df, num_profiles=1000):
...
# Extract 1000 random profiles
profiles_converted = extract_profiles_with_conversion(df, num_profiles=1000)

# Save profiles to a JSON file
output_file = "extracted_1000_random_profiles.json"
